      ...
      <table className="table-auto text-white w-[1180px] lg:w-full ">
        <thead>
          <tr className="border-b border-light-border">
            <th className="text-left py-3 text-custom-gray uppercase text-[1.0625rem]">{thead.id}</th>
            <th className="text-left py-3 text-custom-gray uppercase text-[1.0625rem]">{thead.userName}</th>
            <th className="text-left py-3 text-custom-gray uppercase text-[1.0625rem]">{thead.role}</th>
            <th className="text-left py-3 text-custom-gray uppercase text-[1.0625rem]">{thead.email}</th>
            <th className="text-left py-3 text-custom-gray uppercase text-[1.0625rem]">{thead.phoneNumber}</th>
            <th className="text-left py-3 text-custom-gray uppercase text-[1.0625rem]">{thead.isActive}</th>
            <th className="text-left py-3 text-custom-gray uppercase text-[1.0625rem]">{thead.ipAddress}</th>
            <th className="text-left py-3 text-custom-gray uppercase text-[1.0625rem]">{thead.deviceType}</th>
            <th className="text-left py-3 text-custom-gray uppercase text-[1.0625rem]">{thead.adminAccess}</th>
            <th className="text-left py-3 text-custom-gray uppercase text-[1.0625rem]">{thead.lastLoginDate}</th>
            <th className="text-left py-3 text-custom-gray uppercase text-[1.0625rem] text-center">{thead.actions}</th>
          </tr>
        </thead>
        <tbody>
